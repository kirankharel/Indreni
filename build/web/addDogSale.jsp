...
<html>
    ...
    <body onload="checkURL();">
		...
		<div class="well well-sm">
			...
			<div id="navigation_bar">
				...
				<ul class="nav nav-pills">
				 <li role="navigation"><a href="addOwner?insertion=">Client</a></li>
				  ...
				  <li role="navigation" class="active"><a href="addDogSale?insertion=&owner_id=1" >Dog Sale</a></li>
			...
			<div id="form_div">
				<table>
			        	<form action="dogSaleCheck.jsp" method="get">				
					
					<tr>
						<th>Client Name  : </th>	
                                                <td colspan="2">
                                                    <select id="ownerSelected" name="owner_id" style=" margin-left: 0px;">
					...
					<tr>
						<th>Dog Name : </th>	
						<td colspan="2">
                                                    <select name="dog_id" id="dog_options" style=" margin-left: 0px;">
					...
					<tr>
						<th>Amount :</th>
						<td><input type="text" name="amount" style="height:20px;font-size:20px;width:82%; margin-left: 0px;"></td>
					</tr>
					...
					<tr>
						<th>Date  : </th>	
					        <td><input type="text" placeholder="yyyy-mm-dd" required="true" name="registered_date" id="nepaliDate4" class="nepali-calendar" style="height:20px;font-size:15px; width:82%; margin-left: 0px;">
						</td>		
                                        </tr>
